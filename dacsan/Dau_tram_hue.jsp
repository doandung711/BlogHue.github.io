...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/style_dautramhue.css">
...
ArrayList<SanPhambean> dsSPDau = (ArrayList<SanPhambean>)request.getAttribute("dsSPDau");
%>
    <div id="main">
        <div class="header">
            <div class="abc">
            ...
            <div class="content">
                ...
                <div class="content-bet">
                    <p>
                        ...
                        <strong>Dầu tràm Huế</strong> nguyên chất được sản xuất tại Huế, thành phần hoàn toàn từ thiên nhiên. Giữ ấm, phòng ho, hỗ trợ điều trị chướng bụng đầy hơi, sổ mũi, ngạt mũi, khử sạch vi khuẩn. Giao hàng toàn quốc. Hotline: <a href="">0967001006</a>
                    </p>
                    <p>
                       
                        Dầu tràm Huế được làm hoàn toàn từ nguyên liệu thiên nhiên là cây tràm.
                    </p>
                    <p>
                       
                        Cây tràm có rất nhiều đặc tính ưu việt. Khi ép và chưng cất, lá cho ra dầu tự nhiên 100%. Dung môi nhẹ này có tác dụng khử trùng và diệt nấm. Phân tích thành phần hóa học của dầu tràm cho thấy hai hoạt chất có tác dụng đặc biệt là Eucalyptol chiếm 42-52% và α-Terpineol chiếm 5-12%. Eucalyptol có tác dụng sát khuẩn nhẹ, long đàm.
                    </p>
                    <div class="dia_chi_lien_he">
                        <p>Địa chỉ liên hệ: </p>
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3826.534132810773!2d107.60316361472884!3d16.448470033532068!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3141a16f28fe0625%3A0x9fdb0a1cc6545168!2sTinh%20D%E1%BA%A7u%20Kim%20Vui!5e0!3m2!1svi!2s!4v1676051789354!5m2!1svi!2s" width="750" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
            ...
            <div class="modal js-modal">
                ...
                <div class="content-footer">
                    ...
                    <div class="bai_viet_lien_quan">
                        ...
                        <ul>
                            <li>
                                <a href="http://localhost:8080/Hue/MeXungController">Mè xửng Thiên Hương</a>
