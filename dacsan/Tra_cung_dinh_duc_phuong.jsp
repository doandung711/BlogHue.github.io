...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/style_Tracungdinhhue.css">
...
ArrayList<SanPhambean> dsSPTra = (ArrayList<SanPhambean>)request.getAttribute("dsSPTra");
%>
    <div id="main">
        <div class="header">
            <div class="abc">
            ...
            <div class="content">
                ...
                <div class="content-bet">
                    <p>
                        ...
                        Trà Cung Đình Đức Phượng sẽ là vệ sĩ sát cánh bảo vệ long thể của bạn, giúp cho long thể của bạn luôn sảng khoái mạnh khỏe, không bất an, đủ sức để đương đầu với mọi áp lực của công việc và cuộc sống. Trà được bào chế bởi 16 vị thảo dược Cung Đình nguồn gốc từ thiên nhiên, tinh chế theo bí quyết gia truyền nên rất tốt cho sức khỏe
                    </p>
                    <div class="dia_chi_lien_he">
                        <p>Địa chỉ liên hệ: </p>
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3826.356646006533!2d107.58079881472892!3d16.457469133287884!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3141a149b360534b%3A0x55dd02a2db143d8d!2zVHLDoCBjdW5nIMSRw6xuaCDEkOG7qWMgUGjGsOG7o25n!5e0!3m2!1svi!2s!4v1676052618584!5m2!1svi!2s" width="750" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                ...
                <div class="content-footer">
                    ...
                    <div class="bai_viet_lien_quan">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="http://localhost:8080/Hue/DauTramController">Tinh dầu tràm Huế</a> 
                            </li>
                        </ul>
                    </div>
                </div>
