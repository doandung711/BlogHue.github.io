...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/style_Tramhuonghue.css">
...
ArrayList<SanPhambean> dsSPTram = (ArrayList<SanPhambean>)request.getAttribute("dsSPTram");
%>
    <div id="main">
        <div class="header">
            <div class="abc">
            ...
            <div id="menu">
                <ul>
                    <li>
                        <a href="http://localhost:8080/Hue/index.html">TRANG CHỦ</a>
                    </li>
                    <li>
            ...
            <div class="content">
                ...
                <div class="content-bet">
                    <p>
                        ...
                        Hương trầm Huế có mùi thơm dịu, phảng phất nhẹ nhàng mà sâu lắng. Trước đây muốn có hương trầm phải tìm cho được rễ trầm. Nhưng sau rễ trầm hiếm dần, người ta phải thay bằng các loại rễ cây hương bài hay rễ cây lâu lâu cũng có mùi hương tương tự.
                    </p>
                    <p>
                        Trong thành phần hương liệu của Hương trầm Huế  còn có ngũ vị thuốc bắc ( gồm quế chi, thảo quả, nụ tùng, nụ đinh hương, hoa hồi), cùng với vỏ quả bưởi rừng, hoa bưởi khô. Loại bột làm chất độn để đốt cùng với hương liệu thường mùn cưa. Để tạo chất dẻo ,người làm hương ở Huế nhập vỏ cây bì lời từ Lao Bảo ( Quảng Trị) hay từ Quảng Ngãi. Đây là thành phần quan trọng tạo nên độ kết dính của nguyên liệu.
                    </p>
                    <div class="dia_chi_lien_he">
                        <p>Địa chỉ liên hệ: </p>
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7953.7466299183225!2d107.5751592200115!3d16.442998889969356!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3141a1e09c1f5505%3A0xb0d3b9cbde3df3d9!2zSMawxqFuZyBT4bqhY2ggVMOibiBOZ3V5w6pu!5e0!3m2!1svi!2s!4v1676052994281!5m2!1svi!2s" width="750" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                ...
                <div class="content-footer">
                    ...
                    <div class="bai_viet_lien_quan">
                        ...
                        <ul>
                            <li>
                                <a href="http://localhost:8080/Hue/MeXungControllerl">Mè xửng Thiên Hương</a>
...
<script>
    ...
    function addbuy(SanPhamimg, SanPhamten,SanPhamgia){
        ...
        var divContent = ' <div class="tt-sp"><img id="js-buy-img" src="'+SanPhamimg+'" alt=""><h3 class="title">'+SanPhamten+'</h3> <div class="price"><div class="price"><span>'+SanPhamgia+'</span><p>đ</p></div><p>đ</p></div><input type="number" value="1"><div class="hanh-dong"><i class="ti-trash"></i></div></div>';
